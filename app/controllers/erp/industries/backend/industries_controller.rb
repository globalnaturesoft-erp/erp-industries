  ...
  module Industries
    module Backend
      class IndustriesController < Erp::Backend::BackendController
        ...
        # ARCHIVE /industries/archive?id=1
        def archive
          @industry.archive
          respond_to do |format|
            format.json {
        ...
        # UNARCHIVE /industries/archive?id=1
        def unarchive
          @industry.unarchive
          respond_to do |format|
            format.json {
        ...
        # DELETE ALL /industries/delete_all?ids=1,2,3
        def delete_all         
        ...
        # ARCHIVE ALL /industries/archive_all?ids=1,2,3
        def archive_all         
        ...
        # UNARCHIVE ALL /industries/unarchive_all?ids=1,2,3
        def unarchive_all
